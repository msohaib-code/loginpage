          ...
          <div className="grid grid-cols-1 lg:grid-cols-2   lg:gap-10 ">
                ...
                <div className="gap-4 grid">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 h-[40px] lg:h-[50px] w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2
                 focus:ring-blue-500"
            ...
            <div className=" order-1 lg:order-2 lg:block pt-0 lg:pt-6 w-full h-auto lg:h-[calc(100vh-48px)] ">
              <img
                ...
                className=" rounded-[16px] w-full h-[300px] hidden sm:h-[400px] lg:h-full lg:w-full lg:block
